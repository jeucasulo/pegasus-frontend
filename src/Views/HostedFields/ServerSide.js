        ...
        <>
          ...
          <div className='codeBlock'>
            ...
            <div className='codeBlockBody'>
              ...
              <p> }, <span className='codeBlockVar'>function</span> <span className='codeBlockString'>(</span><span className='codeBlockRequire'>err, result</span><span className='codeBlockString'>)</span> &#123;</p>
              <p> &emsp;result.success;</p>
              <p> &emsp;<span className='commentLine'>// true</span></p>

              <p> &emsp;result.customer.id;</p>
              <p> &emsp;<span className='commentLine'>// e.g 160923</span></p>

              <p> &emsp;result.customer.paymentMethods[<span className='codeBlockRequire'>0</span>].token;</p>
              <p> &emsp;<span className='commentLine'>// e.g f28wm</span></p>
              <p> });</p>
