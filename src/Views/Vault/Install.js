        ...
        <>
          ...
          <div className='codeBlock'>
            ...
            <div className='codeBlockBody'>
              ...
              <p>&emsp;gateway.clientToken.generate(&#123;}, <span className='codeBlockVar'>function</span> <span className='codeBlockString'>(</span><span className='codeBlockRequire'>err, response</span><span className='codeBlockString'>)</span> &#123;</p>
      ...
      return (
        <>
          ...
          <div className='codeBlock'>
            ...
            <div className='codeBlockBody'>
              <p><span className='codeBlockVar'>echo</span>(<span className='codeBlockVarPhp'>$clientToken</span> = <span className='codeBlockVarPhp'>$gateway</span>->clientToken()->generate());</p>
            </div>
          </div>
